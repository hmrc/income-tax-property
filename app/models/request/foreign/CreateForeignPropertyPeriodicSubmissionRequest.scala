...
object CreateForeignPropertyPeriodicSubmissionRequest {
  ...
  def fromForeignPropertyExpenses(
    ...
    val newForeignPropertyExpenses = foreignPropertyExpenses.consolidatedExpenses match {
      case Some(ConsolidatedExpenses(_, Some(consolidatedExpense))) => ForeignPropertyExpenses(None, None, None, None,
        None, None, None, None, None, consolidatedExpense = Some(consolidatedExpense))
