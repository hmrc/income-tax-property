...
final case class AnnualPropertySubmission(
...
object AnnualPropertySubmission {
  implicit val format: OFormat[AnnualPropertySubmission] = Json.format[AnnualPropertySubmission]
}
