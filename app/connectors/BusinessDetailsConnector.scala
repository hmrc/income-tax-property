...
class BusinessDetailsConnector @Inject() (http: HttpClientV2, appConfig: AppConfig)(implicit
  ec: ExecutionContext
) {
  ...
  def getBusinessDetails(
    ...
    val url = s"${appConfig.ifBaseUrl}/registration/business-details/nino/$nino"
    val apiVersion = "1171"
